...
1. The Privacy Officer facilitates the training of all workforce members as follows:
   ...
   4. Existing workforce members as needed due to changes in security and risk posture of Luma.
...
3. The training session focuses on, but is not limited to, the following subjects defined in Luma's security policies and procedures:
   1. HIPAA Privacy, Security, and Breach notification rules;
   2. HITRUST Common Security Framework;
   3. NIST Security Rules;
   4. Risk Management procedures and documentation;
   5. Auditing. Luma may monitor access and activities of all users;
   6. Workstations may only be used to perform assigned job responsibilities;
   7. Users may not download software onto Luma's workstations and/or systems without prior approval from the Security Officer;
   8. Users are required to report malicious software to the Security Officer immediately;
   9. Users are required to report unauthorized attempts, uses of, and theft of Luma's systems and/or workstations;
   ...
   12. Users may not alter ePHI maintained in a database, unless authorized to do so by a Luma Customer;
   13. Users are required to understand their role in Luma's contingency plan;
