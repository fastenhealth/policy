...
15. Direct access to systems continaing ePHI is not possible as controlled by Aptible. Backend access via SSH to a bastion layer is managed with granular, role-based API permissions and 2-factor authentication with FIDO U2F security key support. Architecure design is found here: https://www.aptible.com/assets/aptible-enclave-reference-architecture.pdf
